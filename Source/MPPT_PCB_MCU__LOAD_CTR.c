...
bool Check_if_Active_Errors_Output_Disabled(){
	...
	if (is_Status_NTC1_Over_Temp || is_Status_NTC2_Over_Temp || is_Status_Bias_Error || is_Status_HEAT_NTC_Over_Temp || is_Status_HEAT_NTC_Alert|| is_Status_HEAT_NTC_offline ) {
		// error active
		return true;
	}
